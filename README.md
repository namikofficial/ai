...
### Servers
- `pnpm cli -- api --port 4417`: Start the Express API server.
- `pnpm cli -- web --port 4317 --api-port 4417`: Start the Vite React web dashboard.
