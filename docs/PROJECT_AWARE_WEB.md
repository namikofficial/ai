...
The Work deep link currently uses the existing Dev surface with project inheritance. A complete combined Plan/Task DAG/Run/Checks/Approval timeline remains Phase 7 work. Run, approval, session, handoff, and retrieval-explanation deep links still need dedicated route pages before the deep-link acceptance criterion is complete.
